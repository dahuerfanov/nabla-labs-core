...
from weon_garment_code.assets.garment_programs import sleeves
from weon_garment_code.assets.garment_programs import collars
from weon_garment_code.assets.garment_programs import tee
...
class BodiceHalf(pyg.Component):
    ...
    def add_collars(self, name, body, design):
        ...
        self.collar_comp = collar_type(name, design)

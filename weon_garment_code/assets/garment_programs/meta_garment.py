from weon_garment_code.assets.garment_programs.tee import *
from weon_garment_code.assets.garment_programs.godet import *
from weon_garment_code.garment_programs.weon_pants import *
from weon_garment_code.garment_programs.weon_shirt import *
from weon_garment_code.garment_programs.weon_bands import *
from weon_garment_code.assets.garment_programs.skirt_paneled import *
from weon_garment_code.assets.garment_programs.skirt_levels import *
from weon_garment_code.garment_programs.weon_circle_skirt import *
from weon_garment_code.assets.garment_programs.sleeves import *
...
class MetaGarment(pyg.Component):
    ...
    def __init__(self, name, body, design) -> None:
        ...
        if self.belt_name and Lower:
            ...
            Belt = Belt_class(body, design,
                              waist=Lower.get_waist_width(),
                              waist_back=Lower.get_waist_width(),
                              rise=1.)

...
class BodyParameters(pyg.BodyParametrizationBase):
    ...
    def __init__(self, param_file="") -> None:
        ...
        # Ensure arm_length is preserved if passed in dict
        if isinstance(param_file, dict) and "body" in param_file:
            body_data = param_file["body"]
            if "arm_length" in body_data:
                self.params["arm_length"] = body_data["arm_length"]

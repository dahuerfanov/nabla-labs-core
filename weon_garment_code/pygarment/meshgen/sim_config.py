...
from weon_garment_code.pygarment.data_config import Properties
...
class SimConfig:
    def __init__(self, sim_props):
        ...
        self.max_frame_time = self.get_sim_props_value(
            sim_props, "max_frame_time", None
        )
        ...
        self.spring_kd = self.get_sim_props_value(sim_props_material, "spring_kd", 10.0)
